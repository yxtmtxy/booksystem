...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="datetime-local" name="date" lay-verify="required" lay-reqtext="申请时间不能为空" placeholder="请输入申请时间" autocomplete="off" class="layui-input">
        </div>
    </div>
