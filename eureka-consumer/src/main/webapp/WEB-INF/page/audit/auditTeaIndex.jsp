...
<script>
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            elem: '#currentTableId',
            url: '${pageContext.request.contextPath}/auditTeaAll',//查询全部数据
            ...
            cols: [[
                ...
                {field:'teaId',width:150,title:'申请教师工号', align: "center"},
                {field:'teaName',width:150,title:'申请教师姓名', align: "center"},
                {field: 'number', width: 150, title: '申请数量', align: "center"},
                {field: 'price', width: 150, title: '教材单价', align: "center"},
                {field: 'sum', width: 150, title: '申请教材总价', align: "center"},
