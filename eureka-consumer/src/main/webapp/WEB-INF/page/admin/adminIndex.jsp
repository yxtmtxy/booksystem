        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'adminType', width: 200, align:'center' ,title: '管理员类型',templet:function (res) {
                        if (res.adminType == '0'){
                            return '<span class="layui-btn layui-btn-normal layui-btn-xs">系统管理员</span>';
                        }
                        else if (res.adminType == '1'){
                            return '<span class="layui-btn layui-btn-normal layui-btn-xs" style="background-color: orangered;">教务处管理员</span>';
                        }
                        else if (res.adminType == '2'){
                            return '<span class="layui-btn layui-btn-normal layui-btn-xs" style="background-color: purple;">教师</span>';
                        }
                        else if (res.adminType == '3'){
                            return '<span class="layui-btn layui-btn-normal layui-btn-xs" style="background-color: yellowgreen;">学生</span>';
                        }
                    }},
