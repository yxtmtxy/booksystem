...
<script>
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            elem: '#currentTableId',
            url: '${pageContext.request.contextPath}/bookAll',//查询全部数据
            toolbar: '#toolbarDemo',
            ...
            cols: [[
                ...
                {field: 'publisher', width: 150, title: '出版社', align: "center"},
                {field: 'price', width: 150, title: '单价', align: "center"},
                {field: 'datail', width: 150, title: '详情', align: "center"},
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {  // 监听修改操作
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['100%', '100%'],
                    content: '${pageContext.request.contextPath}/queryBookById?bookId='+data.bookId,
                });
