...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="number" step="0.01" name="price" lay-reqtext="单价不能为空"  value="${info.price}" autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="number" step="0.01" name="sum" lay-reqtext="总价不能为空"  value="${info.sum}" autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="vendorId" lay-reqtext="供应商编号不能为空"  value="${info.vendorId}" autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="datetime-local" name="date" lay-reqtext="入库时间不能为空"  value="${info.date}" autocomplete="off" class="layui-input">
        </div>
    </div>
